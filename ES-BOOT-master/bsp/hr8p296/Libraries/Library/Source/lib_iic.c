...
void I2C_Init(I2C_InitStruType* I2C_InitStruct)
{
	...
	if(I2C_InitStruct->I2C_Mode == I2C_Mode_Master)
	{
		...
		I2C->CON.TJP = temp;      //设置时基定时器周期

		I2C->CON.TJE = 0x1;       //使能时基定时器
	}

	I2C->CON.SDASE = I2C_InitStruct->I2C_16XSamp;  //16倍采样设置
	I2C->CON.SCLSE = I2C_InitStruct->I2C_16XSamp; 
	I2C->CON.SCLOD = I2C_InitStruct->I2C_SclOd;    //端口开漏设置
	I2C->CON.SDAOD = I2C_InitStruct->I2C_SdaOd;
	I2C->MOD.MS = I2C_InitStruct->I2C_Mode;       //主从模式设置
	I2C->MOD.SPAE = I2C_InitStruct->I2C_AutoStop; //自动停止设置
	I2C->MOD.SRAE = I2C_InitStruct->I2C_AutoCall; //自动寻呼设置
